...
class CreateTbAnimalesRazasTable extends Migration
{
    /**
     * Schema table name to migrate
     * @var string
     */
    public $set_schema_table = 'tb_animales_razas';

    /**
     * Run the migrations.
     * @table tb_animales_razas
     *
     * @return void
     */
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('fl_id_raza');
            $table->unsignedinteger('fl_id_especie');
            $table->string('fl_raza_es', 120);
            $table->string('fl_raza_al', 120)->nullable()->default(null);
            $table->string('fl_raza_in', 120)->nullable()->default(null);
